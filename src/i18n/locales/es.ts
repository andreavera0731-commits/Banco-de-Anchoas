export default {
  ...
  stock: {
    ...
    subtitle: 'Registra y consulta los movimientos de inventario.',
    ...
    registerWriteOff: 'Registrar Baja',
    registerRelocation: 'Registrar Reubicación',
    registerAdjustment: 'Registrar Ajuste',
    // Form fields
    selectProduct: 'Producto',
    selectWarehouse: 'Almacén',
    selectSector: 'Sector',
    selectFromWarehouse: 'Almacén de origen',
    selectFromSector: 'Sector de origen',
    selectToWarehouse: 'Almacén de destino',
    selectToSector: 'Sector de destino',
    selectReason: 'Motivo',
    selectAdjustmentType: 'Tipo de ajuste',
    ...
    writeOffSuccess: 'Baja registrada correctamente.',
    relocationSuccess: 'Reubicación registrada correctamente.',
    adjustmentSuccess: 'Ajuste registrado correctamente.',
    // Info panel
    infoTitle: '¿Cómo funciona?',
    infoDescription: 'Gestiona las entradas, salidas, bajas, reubicaciones y ajustes de inventario.',
    infoHowTitle: 'Tipos de movimiento',
    infoHowItems: [
      'Entrada: recepción de mercancía en un sector',
      'Salida: despacho de productos desde un sector',
      'Baja: eliminación por daño, pérdida o expiración',
      'Reubicación: traslado entre sectores',
